...
class DonaturEntity(SQLModel, table=True):
    ...
    idPengguna: Optional[int] = Field(
        default=None, foreign_key="penggunaentity.idPengguna"
    )
    nama: str
...
class BarangEntity(SQLModel, table=True):
    ...
    idPenjual: Optional[int] = Field(
        default=None, foreign_key="penjualentity.idPenjual"
    )
...
class BarangDonasiEntity(SQLModel, table=True):
    ...
    idDonatur: Optional[int] = Field(
        default=None, foreign_key="donaturentity.idDonatur"
    )
    idPenerima: Optional[int] = Field(
        default=None, foreign_key="penerimadonasientity.idPenerima"
    )
    status: str = "pending"
...
class TransaksiEntity(SQLModel, table=True):
    ...
    # Jual Beli
    idBarang: Optional[int] = Field(default=None, foreign_key="barangentity.idBarang")
    idPembeli: Optional[int] = Field(
        default=None, foreign_key="pembelientity.idPembeli"
    )
    # Donasi
    idDonatur: Optional[int] = Field(
        default=None, foreign_key="donaturentity.idDonatur"
...
class PengirimanEntity(SQLModel, table=True):
    ...
    idTransaksi: Optional[int] = Field(
        default=None, foreign_key="transaksientity.idTransaksi"
    )
